    ...
    <div className='m-5'>
      <div className='flex flex-wrap gap-3'>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer'>
          ...
          <div>
            <p className='text-xl font-semibold text-gray-600'>{dashData.total_doctors}</p>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer'>
          ...
          <div>
            <p className='text-xl font-semibold text-gray-600'>{dashData.total_appointments}</p>
            <p className='text-gray-400'>Appoitnments</p>
          </div>
        </div>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer'>
          ...
          <div>
            <p className='text-xl font-semibold text-gray-600'>{dashData.total_users}</p>
