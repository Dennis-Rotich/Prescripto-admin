...
const ForgotPassword = () => {
  ...
  return (
    ...
    <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-xl shadow-2xl transform transition duration-500 hover:scale-[1.01]">
      ...
      <p className="text-sm text-center text-gray-600">Enter your email address and we'll send you a reset link.</p>
      ...
      {message && (
          <p className={`mt-4 text-center text-sm font-medium ${message.includes('sent') ? 'text-green-600' : 'text-red-600'}`}>
            {message}
          </p>
        )}
    </div>
